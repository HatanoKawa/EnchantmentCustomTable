...
- The [tiered matrix](../../tools/gui-validation/tiered-matrix.md) now schedules all 15 versions on both loaders: nine full-suite versions and six quick-suite versions. The [third-round checkpoint](../../tools/gui-validation/round3-2026-09-22.md) records a successful full build matrix, completed GUI checks on both loaders for 1.21.9, 26.1, and 26.2. After two macOS lock interruptions, the user unlocked the Mac and authorized temporary per-client wake assertions; remaining GUI targets are being executed.
