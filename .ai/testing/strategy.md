...
- The [tiered matrix](../../tools/gui-validation/tiered-matrix.md) now schedules all 15 versions on both loaders: nine full-suite versions and six quick-suite versions. The [third-round checkpoint](../../tools/gui-validation/round3-2026-09-22.md) records a successful full build matrix, completed GUI checks on both 1.21.9 clients and Fabric 26.1, and partial NeoForge 26.1 checks. Other GUI targets remain pending after a macOS lock interrupted input.
